...
const OrderSuccessContent = () => {
  ...
  return (
    <main className="flex-grow flex flex-col items-center justify-center p-5 text-center max-w-2xl mx-auto gap-8 py-14 md:py-20">
      ...
      {/* Order summary card */}
      <div className="w-full bg-white border border-slate-100 rounded-[32px] p-8 md:p-10 flex flex-col gap-6 shadow-sm text-left">
        {/* Order ID */}
        ...
        <Link
          ...
          className="w-full bg-slate-900 text-white py-4 rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] shadow-xl shadow-blue-100 hover:bg-slate-900/90 transition-all flex items-center justify-center gap-3"
        >
      ...
      <div className="flex flex-col gap-4 w-full max-w-sm">
        <Link
          ...
          className="w-full bg-white border-2 border-slate-100 text-blue-950 py-4 rounded-full font-black uppercase tracking-widest text-xs hover:bg-white transition-all flex items-center justify-center gap-2"
        >
        ...
        <Link
          href="/shop"
          className="text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-slate-900 transition-colors flex items-center justify-center gap-1"
        >

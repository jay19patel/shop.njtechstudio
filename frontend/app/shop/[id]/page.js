        ...
        <main className="flex-grow w-full max-w-5xl mx-auto px-4 py-8 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 animate-pulse">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="h-8 bg-slate-50 rounded-full w-32" />
              ...
              <div className="h-14 bg-slate-50 rounded-full mt-4" />
            </div>
          </div>
        </main>
        <Footer />
                ...
                {product.images.map((img, idx) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-20 md:w-24 aspect-square rounded-xl md:rounded-2xl overflow-hidden border-2 transition-all ${
                      activeImage === img ? 'border-slate-200 scale-95' : 'border-transparent opacity-60 hover:opacity-100'
                    }`}
                  >
          ...
          <div className="flex flex-col gap-6 md:gap-8 lg:sticky lg:top-32">
            ...
            <div className="flex items-center justify-between mt-4 px-2">
              <div className="flex flex-col items-center gap-2">
                <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-orange-600">
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-slate-900">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
